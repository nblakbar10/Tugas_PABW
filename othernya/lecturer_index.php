...
<body>
    ...
    <h1>Data Dosen</h1>
    <a class="btn btn-primary py-2 float-right mb-4" href="lecturer_input.php">Input Data Dosen</a>
    <?php
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td>
                    <a class='btn btn-light' href='lecturer_edit.php?aksi=edit&&nip=" . $row["nip"] . "'>Edit</a>
