...
<body>
    ...
    <a class="btn btn-primary py-2 float-right mb-4" href="subject_input.php">Input Data Mata Kuliah</a>
    <?php
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td>" . $row["semester"] . "</td>
                    <td>
                    <a class='btn btn-light' href='subject_edit.php?aksi=edit&&id=" . $row["id"] . "'>Edit</a>
